...
class BPlusTree(object):
    ...
    def _insert(self, key, value):
        ...
        # self.digest_value.append(pickle.dumps(self.digest_value_temp))
        # e_t1 = time.perf_counter()
        # construct_time = e_t1 - s_t1
        # self.time_cost_construct += construct_time

    def insert(self, key, value):

        self.count += 1

        # s_t2 = time.perf_counter()
    ...
    def delete(self, key):
        ...
        # e_t2 = time.perf_counter()
        # construct_time = e_t2 - s_t2
        # self.time_cost_construct += construct_time
    ...
    def calculate_leaf_hash(self):
        ...
        # e_t3 = time.perf_counter()
        # construct_time = e_t3 - s_t3
        # self.time_cost_construct += construct_time

    def calculate_non_leaf_hash(self):

        # s_t4 = time.perf_counter()
        ...
        # e_t4 = time.perf_counter()
        # construct_time = e_t4 - s_t4
        # self.time_cost_construct += construct_time
    ...
    def range_query(self, id_set, start_key, end_key):
        ...
        # vo = self.construct_vo(self.root,start_key,end_key)
...
#     bplustree.insert(10, 'Kilo')
    ...
    #
    # bplustree.delete(2)
    # bplustree.insert(77, 'Charlie')
    #
    # bplustree.delete(9)
    # bplustree.insert(25, 'Juliet')
    #
    # bplustree.delete(81)
    # bplustree.insert(73, 'Bravo2')
    #
    # bplustree.delete(10)
    # bplustree.insert(666, 'Kilo')
    #
    # bplustree.delete(11)
    # bplustree.insert(42, 'Lima')
    #
    # bplustree.delete(12)
    # bplustree.insert(72, 'Mike')
    #
    # bplustree.delete(17)
    # bplustree.insert(18, 'Romeo')
    ...
    # #     print(c)
    # print(c.values)
    # d = bplustree.construct_vo(c, 0, 300)
    # print(d)
